...
export default function App() {
  ...
  // Khởi tạo Agora Video/Audio Call dựa trên roomId chung
  useEffect(() => {
    if (!hasJoined) return;
    let isMounted = true;
  ...
  const claimHostRole = () => {
    if (existingHost) return alert("Phòng đã có Quản Trò!");
    setIsHost(true);
